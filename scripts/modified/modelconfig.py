...
layer5 = 'model.model.1.model.3.model.3.model.3.model.1'
layer9 = 'model.model.1.model.3.model.3.model.3.model.3.model.3.model.3.model.3'
layer12 = 'model.model.1.model.3.model.3.model.3.model.5'
...
def annotate_model_shapes(model, gen=False, imgsize=None):
    ...
    if gen:
        child = next(model.children())
        if hasattr(model, 'input_shape') and model.input_shape is not None:
            input_shape = model.input_shape
        elif hasattr(child, 'input_shape'):
            ...
            if isinstance(first_layer, (torch.nn.Conv2d, torch.nn.ConvTranspose2d)):
                input_shape = (1, first_layer.in_channels, 256, 256)
            else:
